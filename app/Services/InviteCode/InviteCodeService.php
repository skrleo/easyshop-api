...
class InviteCodeService implements HashGenerator
{
    const VERSION = '1.0.5';
    ...
    private $_alphabet = 'abcdefghijkmnpqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ23456789';
